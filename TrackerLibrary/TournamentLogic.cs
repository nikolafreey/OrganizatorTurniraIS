...
namespace TrackerLibrary
{
    public static class TournamentLogic
    {
        ...
        private static void MarkWinnersInMatchups(List<MatchupModel> models)
        {
            ...
            {
                // Provjeravamo da li imamo samo jedan tim na utakmici
                ...
                if (greaterWins == "0")
                {
                    // 0 znaci da je bolji manji rezultat
                    ...
                    {
                        throw new Exception("Aplikacija ne podrzava nerjesene ishode utakmica!");
                    }
                }
                else
                {
                    // 1 znaci da je bolji veci rezultat
                    if (m.Entries[0].Score > m.Entries[1].Score)
                    {
                        m.Winner = m.Entries[0].TeamCompeting;
                    }
